import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, v as Primitive, w as cn, F as Settings, U as Users, G as useGetPlatformStats, M as MessageSquare, e as BookOpen, B as Button, I as useListBannedWords, J as useAddBannedWord, K as useRemoveBannedWord, N as useScanAndDeleteBannedGroups, O as useDeleteGroupsWithWord, S as Shield, L as LoaderCircle, Q as useGetAllPosts, R as useGetAllComments, s as useGetAllStudyGroups, T as useAdminDeletePost, W as useAdminDeleteComment, X as useAdminDeleteStudyGroup, y as useGetAllUsers, Y as useGetSuspendedUsers, Z as useSuspendUser, _ as useUnsuspendUser, z as useGetReports, C as useReviewReport, V as Variant_resolved_pending_reviewed, a as ue } from "./index-DNXQSw_4.js";
import { a as Tabs, b as TabsList, c as TabsTrigger, d as TabsContent, T as TriangleAlert, B as Badge } from "./tabs-s7EAAVTv.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent, d as CardDescription } from "./card-OOTnljHx.js";
import { D as Dialog, e as DialogTrigger, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, f as DialogFooter } from "./dialog-BUSqyeSY.js";
...
function ConfirmDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: setOpen, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { "data-ocid": dialogOcid, children: [
...
function StatsTab() {
  ...
  const statCards = [
    {
      label: "Total Users",
      value: stats == null ? void 0 : stats[0],
      icon: Users,
      color: "text-blue-500"
    },
    {
      label: "Total Posts",
      value: stats == null ? void 0 : stats[1],
      icon: FileText,
      color: "text-emerald-500"
    },
    {
      label: "Total Comments",
      value: stats == null ? void 0 : stats[2],
      icon: MessageSquare,
      color: "text-violet-500"
    },
    {
      label: "Study Groups",
      value: stats == null ? void 0 : stats[3],
      icon: BookOpen,
      color: "text-amber-500"
    },
    {
      label: "Total Reports",
      value: stats == null ? void 0 : stats[4],
      icon: Flag,
      color: "text-rose-500"
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Platform Overview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Live statistics across all platform activity" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5", children: statCards.map(({ label, value, icon: Icon, color: color2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `h-5 w-5 ${color2}` })
      ] }),
...
function BannedWordsTab() {
  ...
  const [targetWord, setTargetWord] = reactExports.useState("epistein");
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      setNewWord("");
      ue.success(`"${w}" added to banned words list`);
    } catch (e) {
      ue.error(errMsg(e, "Failed to add banned word"));
    }
  };
  const handleRemove = async (word) => {
    try {
      await removeWord.mutateAsync(word);
      ue.success(`"${word}" removed from banned words list`);
    } catch (e) {
      ue.error(errMsg(e, "Failed to remove banned word"));
    }
  };
  const handleScanDelete = async () => {
    try {
      await scanAndDelete.mutateAsync();
      ue.success("Scan complete — offending groups deleted");
    } catch (e) {
      ue.error(errMsg(e, "Scan failed"));
    }
  };
  const handleDeleteMatchingGroups = async () => {
    const word = targetWord.trim();
    if (!word) {
      ue.error("Please enter a word to search for");
      return;
    }
    try {
      ...
      ue.success(
        n === 0 ? `No study groups found containing "${word}"` : `Deleted ${n} study group${n !== 1 ? "s" : ""} containing "${word}"`
      );
    } catch (e) {
      ue.error(errMsg(e, "Failed to delete matching groups"));
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Banned Words" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Words that automatically block study group creation" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ConfirmDialog,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-destructive/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-4 w-4 text-destructive" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Targeted Group Deletion" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Delete all existing study groups whose name or description contains a specific word (case-insensitive, partial match). Future groups with this word are already blocked automatically." })
      ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "label",
            {
              ...
              children: "Word to match (partial, case-insensitive)"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                onKeyDown: (e) => e.key === "Enter" && handleDeleteMatchingGroups(),
                className: "pl-9",
          ...
          ConfirmDialog,
          {
            trigger: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                disabled: !targetWord.trim() || deleteGroupsWithWord.isPending,
                "data-ocid": "admin.targeted_deletion.delete_button",
                children: [
                  deleteGroupsWithWord.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "Add Banned Word" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              addWord.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "mr-2 h-4 w-4" }),
              "Add"
            ]
          }
        )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-medium", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "ml-2", children: (words == null ? void 0 : words.length) ?? 0 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Click the trash icon to remove a word from the list" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      ) : !(words == null ? void 0 : words.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "py-8 text-center text-sm text-muted-foreground",
          "data-ocid": "admin.banned_words.empty_state",
          children: "No banned words added yet."
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-96", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: words.map((word, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
...
function ContentTab() {
  ...
  const handleDeletePost = async (postId) => {
    try {
      ...
      ue.error(errMsg(e, "Failed to delete post"));
    }
  };
  const handleDeleteComment = async (commentId) => {
    try {
      await deleteComment.mutateAsync(commentId);
      ue.success("Comment deleted successfully");
    } catch (e) {
      ue.error(errMsg(e, "Failed to delete comment"));
    }
  };
  const handleDeleteGroup = async (groupId) => {
    try {
      await deleteGroup.mutateAsync(groupId);
      ue.success("Study group deleted successfully");
    } catch (e) {
      ue.error(errMsg(e, "Failed to delete group"));
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Content Management" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Review and remove posts, comments, and study groups" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "posts", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "posts", children: [
          "Posts",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "ml-2", children: (posts == null ? void 0 : posts.length) ?? 0 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "comments", children: [
          "Comments",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "ml-2", children: (comments == null ? void 0 : comments.length) ?? 0 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "study-groups", children: [
          "Study Groups",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "ml-2", children: (groups == null ? void 0 : groups.length) ?? 0 })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "posts", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "All Posts" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: postsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "space-y-3",
            "data-ocid": "admin.posts.loading_state",
            children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-full" }, i))
          }
        ) : !(posts == null ? void 0 : posts.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "py-8 text-center text-sm text-muted-foreground",
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-[500px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: posts.map((post, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex items-start justify-between gap-3 rounded-md border p-3",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-sm", children: post.content || "(No text content)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex gap-3 text-xs text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: shortPrincipal(post.author) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatTimestamp(post.timestamp) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "comments", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "All Comments" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: commentsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "space-y-3",
        ...
        ) : !(comments == null ? void 0 : comments.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "py-8 text-center text-sm text-muted-foreground",
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-[500px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: comments.map((comment, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex items-start justify-between gap-3 rounded-md border p-3",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-sm", children: comment.content }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex gap-3 text-xs text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: shortPrincipal(comment.author) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatTimestamp(comment.timestamp) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    "Post #",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "study-groups", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "All Study Groups" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: groupsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "space-y-3",
        ...
        ) : !(groups == null ? void 0 : groups.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "py-8 text-center text-sm text-muted-foreground",
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-[500px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: groups.map((group, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex items-start justify-between gap-3 rounded-md border p-3",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate font-medium text-sm", children: group.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-xs text-muted-foreground", children: group.description }),
...
function UsersTab() {
  ...
  const { data: suspendedUsers, isLoading: suspendedLoading } = useGetSuspendedUsers();
  const suspend = useSuspendUser();
  const unsuspend = useUnsuspendUser();
  const suspendedSet = new Set((suspendedUsers ?? []).map((p) => p.toString()));
  const handleSuspend = async (user) => {
    try {
      await suspend.mutateAsync(user.principal);
      ue.success("User suspended");
    } catch (e) {
      ue.error(errMsg(e, "Failed to suspend user"));
    }
  };
  const handleUnsuspend = async (user) => {
    try {
      await unsuspend.mutateAsync(user.principal);
      ue.success("User unsuspended");
    } catch (e) {
      ue.error(errMsg(e, "Failed to unsuspend user"));
    }
  };
  const isLoading = usersLoading || suspendedLoading;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "User Management" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "View all users, suspend or unsuspend accounts" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-medium", children: [
        "All Users",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "ml-2", children: (users == null ? void 0 : users.length) ?? 0 })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "admin.users.loading_state", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-full" }, i)) }) : !(users == null ? void 0 : users.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "py-8 text-center text-sm text-muted-foreground",
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-[600px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: users.map((user, idx) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate font-medium text-sm", children: user.name || "(No name)" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-0.5 flex gap-3 text-xs text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: user.email || "—" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 font-mono", children: shortPrincipal(user.principal) })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex shrink-0 gap-2", children: isSuspended ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                ConfirmDialog,
                {
                  trigger: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
...
function ReportsTab() {
  ...
  const handleReview = async (reportId, status) => {
    try {
      ...
      ue.error(errMsg(e, "Failed to update report"));
    }
  };
  const statusConfig = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Reports" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Review and action content and user reports" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-medium", children: [
        "All Reports",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "ml-2", children: (reports == null ? void 0 : reports.length) ?? 0 })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "admin.reports.loading_state", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 w-full" }, i)) }) : !(reports == null ? void 0 : reports.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "py-8 text-center text-sm text-muted-foreground",
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-[600px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: reports.map((report, idx) => {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: formatTimestamp(report.timestamp) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: report.reason }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5 text-xs text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    "Reporter:",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: shortPrincipal(report.reporter) })
                  ] }),
                  report.reportedUser && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    "Reported User:",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: shortPrincipal(report.reportedUser) })
                  ] }),
                  report.reportedContent && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "truncate", children: [
                    "Content:",
                    " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex shrink-0 flex-col gap-2", children: [
                report.status !== Variant_resolved_pending_reviewed.reviewed && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    size: "sm",
                    variant: "outline",
                ...
                report.status !== Variant_resolved_pending_reviewed.resolved && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    size: "sm",
                    className: "gap-1.5 text-xs",
...
function AdminPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container py-8", children: [
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-xl bg-destructive/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "h-6 w-6 text-destructive" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Admin Panel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Platform management & moderation — ICSE Crowd" })
            ] })
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "stats", className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "h-auto flex-wrap gap-1 p-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
            value: "stats",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "stats", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatsTab, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "banned-words", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BannedWordsTab, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContentTab, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "users", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UsersTab, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "reports", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ReportsTab, {}) })
          ]
        },
        "tab-content"
      )
